...
#  
#  
#  >>> df = spark.sql("select src, tgt, label from sentences_parquet2 where length(src) < 40")
...
#  
#  
#  spark-sql> select src, tgt, label from sentences_parquet2 where length(src) < 40 and label='M' limit 10;
#  
#  B. B.	बी.	M
